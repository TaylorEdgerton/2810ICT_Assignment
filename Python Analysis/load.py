...
class CSVDataSource(gridlib.GridTableBase):
    ...
    def LoadFile(self, fileName='./Crash Statistics Victoria.csv'):
        fileName = './Crash Statistics Victoria.csv'
...
class MyFrame(wx.Frame):
    def __init__(self, parent, title):
        ...
        sizer = wx.BoxSizer()
        self._file = 'Crash Statistics Victoria.csv'
...
class VicAccidentStatsApp(wx.App):
    def OnInit(self):
